...
void ingresarDatosEst(struct DatosGen *datosgen, int j){
  ...
  printf("\n Datos guardados!\nRegresando al menú principal, presione ""Esc"" dos veces...");  
}
...
void ingresarDatosDoc(struct DatosGen *datosgen, int j){
  ...
  printf("-------------------------------------------------------------------------\n\t\t   Formación profesional del docente %d:\n-------------------------------------------------------------------------\n",j);
  ...
  printf("\nNivel de formación:\n");
    ...
    int nivelEduc;
    do {
        printf("Ingrese la opción correspondiente: ");
        scanf("%d", &nivelEduc);
        ...
        switch (nivelEduc) {
            ...
            case 2:
                ...
                break;
            case 3:
                strcpy(datosgen->docente.titulo.niveleducacion, "Maestría");
                break;
            case 4:
